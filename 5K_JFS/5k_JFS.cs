...
app.Command("demo", command =>
{
    ...
    var samplesPerPixel = command.Option("-spp|--samples-per-pixel <SAMPLES_PER_PIXEL>", "Number of samples per pixel.. \t Default: 1", CommandOptionType.SingleValue);
    ...
    var orthogonal = command.Option("-o|--orthogonal", "Use an orthogonal camera \t Default: perspective", CommandOptionType.NoValue);
